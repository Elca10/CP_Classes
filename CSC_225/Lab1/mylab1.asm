...
# Name:
.data
Name: .string "Eliska Jelinek" # Your name in double quotes
...
decval5:	.word -128  # 10000000b     1111111     +1:    10000000 # OVERFLOW
...
CarryNoOV1:	.word	11  # Replace DDD with a decimal value.
CarryNoOV2:	.word	103  # Replace DDD with a decimal value.
...
SignNoCarry1:	.word	100  # Replace DDD with a decimal value.
SignNoCarry2:	.word	100  # Replace DDD with a decimal value.
